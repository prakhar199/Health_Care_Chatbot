...
training_dataset = pd.read_csv(r'C:\ML-Projects-master\health_Care_chatbot\Training.csv')
test_dataset = pd.read_csv(r'C:\ML-Projects-master\health_Care_chatbot\Testing.csv')
